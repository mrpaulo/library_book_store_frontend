export const en = {
  ...
  errors: {
    ...
    end_date_before: "End date has to be after than start date",
    password_required: "Password is required!",
    publisher_required: "Publisher is required!",
    repeat_password_required: "Repeat the password is required!",
    start_date_after: "Please choose past date",
  ...
  labels: {
    ...
    role: "Role",
    sex: "Sex",
    start_date_birth: "Birthday start date",
    start_date_create: "Foundation start date",
    start_date_publish: "Publication start date",
    state: "State",
    subject: "Subject",
    subtitle: "Subtitle",
    title: "Title",
  ...
  messages: {
    ...
    passwords_match: "The passwords need to match",
    table_all_itens: "All",
...
export const pt = {
  ...
  errors: {
    ...
    end_date_before: "Data final precisa ser depois de data inicial",
    password_required: "Senha é obrigatório!",
    publisher_required: "Editora é obrigatória!",
    repeat_password_required: "Repetir a senha é obrigatório!",
    start_date_after: "Por favor escolha uma data inicial antes de hoje",
  ...
  messages: {
    ...
    passwords_match: "As senhas precisam ser iguais",
