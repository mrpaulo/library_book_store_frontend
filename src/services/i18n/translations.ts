...
export const pt = {
  ...
  menu: {
    ...
    add_author: "Adicionar pessoa",    
    books: "Livros",
    publishers: "Empresas",
    authors: "Pessoas",
    search_books: "Consultar Livros",
    search_publishers: "Consultar Empresas",
    search_authors: "Consultar Pessoas",
  },
  messages: {
  ...
  titles: {
    ...
    edit_author: "Editar Pessoa",    
    edit_publisher: "Editar Empresa",  
    search_books: "Consulta Livros",
    search_publishers: "Consulta Empresa",
    search_authors: "Consulta Pessoas",
    search_result: "Resultado da Consulta",
    submit_address: "Registrar Endereço",
    submit_book: "Registrar Livro",
    submit_publisher: "Registrar Empresa",
    submit_author: "Registrar Pessoa",
  },
  tooltip: {
    address: "endereço",
